                ...
                <a class="dropdown-toggle" data-toggle="dropdown" href="#">Cursos
                    ...
                    <li class="dropdown">
                        <a href="<c:url value="Executa">
                               <c:param name="tarefa" value="CadastrarModulo"></c:param></c:url>">Cadastrar Módulos</a>

                           <li class="dropdown"><a href="<c:url value="Executa">
                                                <c:param name="tarefa" value="ConsultarModulos">
                                                </c:param></c:url>">Consultar Modulos</a></li>
                        ...
                        <li class="dropdown"><a href="<c:url value="Executa">
                                                ...
                                                </c:param></c:url>">Consultar Turmas</a></li>
                    </ul>
                <li class="dropdown">
